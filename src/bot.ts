...
export interface Session {
  step?: "idle" | "awaiting_question" | "awaiting_clarification" | "awaiting_feedback";
  language?: "en" | "ru";
  pendingQuestion?: string;
  pendingQuestionId?: string;
  currentAnswer?: { id: string; title: string; snippet: string };
  currentItem?: { type: "role" | "drill"; id: string };
}
